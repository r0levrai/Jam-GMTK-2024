...
public class Classify : MonoBehaviour
{
    ...
    void Start()
    {
		...
		classes = new string[32] { "The Eiffel Tower", "airplane", "ant", "banana", "bee", "book", "bus", "car", "cow", "elephant", "eyeglasses", "helicopter", "ice cream", "kangaroo", "key", "moon", "mosquito", "mountain", "mouse", "owl", "parrot", "piano", "scissors", "toilet", "tooth", "tractor", "traffic light", "trumpet", "umbrella", "whale", "wine bottle", "wine glass" };
